...
function print_pricing_items() {
	global $post; ?>
	<div class="row">
		<div class="title span6"><?php the_title(); ?></div>
		<div class="price span3"><?=get_post_meta(get_the_ID(), 'pricing_price', true)?></div>
		<div class="paypal_button span3">
	...
	<div class="row">
		<div class="content_row span12"><?php the_content(); ?></div>
	</div>
	<?php
}
get_header(); ?>
<section id="page">
    <div class="container">
		...
		<div class="pricing-table membership-level">
			<div class="row">
				<div class="span12"><?=get_term_by('slug', 'membership-level', 'cat_pricing')->name?></div>
			</div>
		<?php
		...
		<div class="pricing-table option">
			<div class="row">
				<div class="span12"><?=get_term_by('slug', 'option', 'cat_pricing')->name?></div>
			</div>
		<?php
			$query = new WP_Query( array(
				'post_type' => 'zee_pricing',
		...
		<div class="pricing-table ">
			...
			<div class="row">
				<div class="span8">Additional donation to the MAS General Fund to cover operating costs*</div>
				<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
				<input type="hidden" name="cn" value="Comments, suggestions?">
				<input type="hidden" name="no_note" value="0">
				<input type="hidden" name="no_shipping" value="2">
				...
				<div class="span4">
					$<input type="text" size="8" name="amount" value="0.00" />
				</div>
				<div class="span4">
					<input type="image" src="<?=get_template_directory_uri()?>/add_to_cart.png" border="0" name="I2" alt="Make payments with PayPal - it's fast, free and secure!">
				</div>

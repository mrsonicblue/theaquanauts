 ...
 */
class Ai1ec_Controller_Ai1ecev extends Ai1ec_License_Controller {


	/* (non-PHPdoc)
	 * @see Ai1ec_Extension_Controller::get_name()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_Extension_Controller::get_machine_name()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_Extension_Controller::get_version()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_License_Controller::get_license_label()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_License_Controller::add_tabs()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_Extension_Controller::on_deactivation()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_Extension_Controller::_set_settings()
	 */
	...
	/* (non-PHPdoc)
	 * @see Ai1ec_Extension_Controller::_register_actions()
	 */
